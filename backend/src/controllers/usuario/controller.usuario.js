...
export const actualizarUsuario = async (req, res) => {
    try {
        const { nombre_usuario, apellido_usuario, telefono_usuario, correo_usuario, contrasena_usuario, estado_usuario, id_rol_fk } = req.body;
        const dni_usuario_pk = req.params.dni_usuario_pk;
        ...
        const result = await pool.query(sql, [nombre_usuario, apellido_usuario, telefono_usuario, correo_usuario, contrasena_usuario, estado_usuario, id_rol_fk, dni_usuario_pk]);
        if (result.rowCount > 0) {
